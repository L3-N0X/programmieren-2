    ...
    private void spawnGameObjectsFromWorldString() {
        ...
        for (int i = 0; i < lines.length; i++) {
            for (int j = 0; j < lines[i].length(); j++) {
                ...
                double tileWidthInPixels = 4 * 128 - 1;
                double tileHeightInPixels = 4 * 112 - 1;

                double offsetXInPixels = TILE_OFFSET_COLUMNS_IN_BLOCKS * 4;
                double offsetYInPixels = TILE_OFFSET_LINES_IN_BLOCKS * 4;
