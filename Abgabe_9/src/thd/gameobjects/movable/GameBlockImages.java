 ...
 */
public final class GameBlockImages {
    ...
    /**
     * This enum contains all car rotations.
     */
    enum CarTiles {
        ROT_00("""
                                 LL      LL          \s
    ...
    public enum TrackTiles {
        ...
        VERTICAL("""
                         ...
                         """);
        private final String tile;
        private final ArrayList<CollisionOffsets> collisionOffsets;
        /**
         * The width of a CarTile in blocks.
         */
        ...
        TrackTiles(String tile) {
            this.tile = tile;
            this.collisionOffsets = new ArrayList<>();
        }
