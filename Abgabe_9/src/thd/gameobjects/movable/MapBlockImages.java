...
public final class MapBlockImages {
    ...
    public enum MapTileImage {
        ...
        /**
         * Returns the precalculated Block Array for the map tile, useful to check which char is at a certain position.
         *
         * @return a char matrix of the block image.
         */
        char[][] getBlockArray() {
            return blockArray;
        }
        ...
        /**
         * This returns the spawn rotations for the map tile.
         *
         * @return the possible spawn rotation for this tile.
         */
        ArrayList<Integer> getPossibleRotations() {
