...
public class Overlay extends GameObject {
    ...
    /**
     * Shows the given message until {@link #stopShowing()} is called. Until then all further calls of this method are
     * ignored.
     *
    ...
    /**
     * Shows the given message for the given number of seconds or until {@link #stopShowing()} is called. Until then all
     * further calls of this method are ignored.
     *
     * @param message       Message to be shown.
    ...
    private void centerMessage() {
        ...
        position.updateCoordinates((GameView.WIDTH - textWidth) / 2d, (GameView.HEIGHT - textHeight) / 2d - 200);
    }
