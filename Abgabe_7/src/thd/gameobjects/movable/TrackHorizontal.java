...
public class TrackHorizontal extends GameObject {
     ...
     */
    public TrackHorizontal(GameView gameView, GamePlayManager gamePlayManager) {
    ...
    public void addToCanvas() {
        gameView.addBlockImageToCanvas(GameBlockImages.TrackTiles.HORIZONTAL.blockImage(), position.getX(),
